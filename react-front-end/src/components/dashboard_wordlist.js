				...
				<div className="content-container">
					...
					Use the ePub uploader in your dashboard to save a book to your
					 library and begin improving your foreign language comprehension.
						...
						<ul>
							<p>
							<li>Click any word and receive a <div className="bold-words">live translation</div> instantly</li>
							</p>
							<p>
							<li>Practice these words with <div className="bold-words">flashcards</div></li>
							</p>
						</ul>
